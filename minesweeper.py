...
class Minesweeper():
    ...
    def is_mine(self, cell):#cell是一个元组，代表坐标
        i, j = cell
...
class Sentence():
    ...
    def __init__(self, cells, count):
        self.cells = set(cells)#cells是一个元组的集合，代表坐标
        self.count = count
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        while changed:
            ...
            mines_to_mark = set()
            for sentence in self.knowledge:
                safes_to_mark |= sentence.known_safes()#|=是集合的并集运算
    ...
    def make_safe_move(self):
        ...
        """
        for safe in self.safes - self.moves_made:
            return safe
        return None
